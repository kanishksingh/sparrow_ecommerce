...
// Images Directory
imagesDir = "DashboardResources/Editor/icons/";

// CSS Directory
cssDir = 'DashboardResources/Editor/styles/';

// Popups Directory
popupsDir ='DashboardResources/Editor/popups/';
...
function generate_wysiwyg(textareaID) {
  ...
  var toolbar2;
  toolbar2 = '<table cellpadding="0" cellspacing="0" border="0" class="toolbar2" style="width:' + toolbarWidth + '%;"><tr><td style="width: 6px;"><img src="' +imagesDir+ 'seperator2.gif" alt="" hspace="3"></td>';
  ...
  toolbar2 += '<td>&nbsp;</td></tr></table>';  
	...
	var iframe = '<table cellpadding="0" cellspacing="0" border="0" style="width:' + wysiwygWidth + '%; height:' + wysiwygHeight + 'px;border: 1px inset #CCCCCC;"><tr><td valign="top">\n'
